...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  if(isset($_POST['guardar'])){
    if(empty($errores)){
      $errores = agregar_costo();
    }
  }
}

$titulo = "Costos | Sistema de control presupuestario"
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="row">
          <div class="col-md-4 order-md-2 mb-4">
            ...
            <div class="col-md-8 order-md-1">
              <form method="POST" id="formulario_costo" name="formulario_costo">
                <div class="row">
                  <div class="col-sm-12 mb-3">
                   <table class="table table-hover" id="tabla_costo">
                    <thead>
