...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  if(isset($_POST['guardar'])){
    if(empty($errores)){
      $errores = agregar_precio();
    }
  }
}

$titulo = "Valores | Sistema de control presupuestario"
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="row">
          <div class="col-md-4 order-md-2 mb-4">
            ...
            <div class="col-md-8 order-md-1">
              <form method="POST" id="formulario_precio" name="formulario_precio">
                <div class="row">
                  <div class="col-sm-12 mb-3">
                   <table class="table table-hover" id="tabla_precio">
                    <thead>
                      <tr class="table-active"><th></th><th width="40%">Nombre</th><th width="5%">Unidad</th><th style="text-align: right;" width="5%">Cantidad</th><th style="text-align: right;" width="25%">Precio ($)</th><th style="text-align: right;" width="25%">Subtotal ($)</th></tr>
                    </thead>
                    <?php ver_presupuesto2();?>
                  </table>
                </div>
              </div>

              <button class="btn btn-primary btn-lg btn-block" name="guardar" type="submit">Guardar</button>
            </form>
          </div>
        </div>
      </div>
