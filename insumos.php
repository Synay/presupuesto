...
require_once "./functions/funcionesSubcategoria.php";
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  if(isset($_POST['guardar'])){
    if(empty($errores)){
     $errores = guardar_insumo();
   }
 }
}

$titulo = "Insumos | Sistema de control presupuestario"
?>
<!DOCTYPE html>
<html lang="es">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
       ...
       <div class="container">
        ...
        <div class="col-md-8 order-md-1">
          <form method="POST" id="formulario_categoria">
            <h4 class="mb-3">Insumos, materiales y otros:</h4>
            <div class="row">
              <div class="col-sm-12 mb-3">
                <?php listar_subcategoria();?>
              </div>
            </div>

            <button class="btn btn-primary btn-lg btn-block" name="guardar" type="submit">Finalizar</button>
          </form>
        </div>
      </div>
    </div>
